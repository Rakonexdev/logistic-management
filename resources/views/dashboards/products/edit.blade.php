            ...
            <div class="form-row">
                <div class="form-group" id="serial-numbers-group">
                    ...
                    <div id="serial-inputs-wrapper" style="display: flex; flex-direction: column; gap: 0.5rem;">
                        @php
                            $serials = $product->serial_number ? array_filter(array_map('trim', explode(',', $product->serial_number))) : [''];
                        @endphp
                        @foreach($serials as $serial)
                            <div class="serial-input-row" style="display: flex; gap: 0.5rem; align-items: center;">
                                <input type="text" name="serial_numbers[]" class="form-control" value="{{ $serial }}" placeholder="e.g. SN-12345" style="flex: 1;">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="qty" class="form-control" id="qty-input" value="{{ old('qty', $product->qty) }}" min="0" required>
