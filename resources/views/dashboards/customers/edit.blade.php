...
@section('content')
    <div class="page-header">
        <h1 class="page-title">
            <i class="ph ph-pencil-line" style="color: var(--accent-primary);"></i>
            Edit Customer
        </h1>
    ...
    <div class="glass form-panel">
        <form action="{{ route('customers.update', $customer) }}" method="POST">
            ...
            @php
                $rawContact = $customer->contact_number ?? '';
                $countryCode = '+974';
                if (str_starts_with($rawContact, '+971')) {
                    $countryCode = '+971';
                } elseif (str_starts_with($rawContact, '+974')) {
                    $countryCode = '+974';
                }
            ...
            <div class="form-group">
                ...
                <div style="display: flex; gap: 0.5rem;">
                    ...
                    <input type="text" id="contact_number_digits" name="contact_number_digits" class="form-control @error('contact_number_digits') is-invalid @enderror @error('contact_number') is-invalid @enderror" value="{{ old('contact_number_digits', $digits) }}" placeholder="8-digit number" maxlength="8" pattern="[0-9]{8}" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                </div>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="ph ph-check"></i> Update Customer
                </button>
            </div>
        </form>
    </div>
