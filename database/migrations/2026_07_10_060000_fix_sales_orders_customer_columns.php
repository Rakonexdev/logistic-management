...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('sales_orders', function (Blueprint $table) {
            if (Schema::hasColumn('sales_orders', 'customer_destination') && ! Schema::hasColumn('sales_orders', 'customer_name')) {
    ...
    {
        Schema::table('sales_orders', function (Blueprint $table) {
            if (Schema::hasColumn('sales_orders', 'customer_name') && ! Schema::hasColumn('sales_orders', 'customer_destination')) {
